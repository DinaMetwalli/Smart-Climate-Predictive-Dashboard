...
from src.models_testing.multi_input_output.multi_input_output_model import MultiContinentForecastingModel
...
def main():
    ...
    # Initialize model
    model = MultiContinentForecastingModel(seq_len=60,forecast_num=36)
